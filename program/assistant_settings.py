...
@Client.on_message(
    command(["userbotjoin", f"نضم"]) & other_filters
)
@check_blacklist()
...
@Client.on_message(
    command(["userbotleave", f"ادر"]) & other_filters
)
@check_blacklist()
@authorized_users_only
...
@Client.on_message(command(["leaveall", f"مغادره"]) & ~filters.edited)
@bot_creator
...
@Client.on_message(command(["startvc", f"بدء"]) & other_filters)
@check_blacklist()
@authorized_users_only
...
@Client.on_message(command(["stopvc", f"قفل"]) & other_filters)
@check_blacklist()
@authorized_users_only
