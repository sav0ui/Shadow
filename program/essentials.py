...
@Client.on_message(command(["broadcast", f""]) & ~filters.edited)
@bot_creator
...
@Client.on_message(command(["broadcast_pin", f""]) & ~filters.edited)
@bot_creator
...
@Client.on_message(command(["stats", f""]) & ~filters.edited)
@sudo_users_only
